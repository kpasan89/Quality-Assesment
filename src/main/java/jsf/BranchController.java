...
import sessionbeans.BranchFacade;
...
public class BranchController implements Serializable {
    ...
    @EJB
    private sessionbeans.BranchFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("BranchCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("BranchUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("BranchDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Branch> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Branch> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class BranchControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Branch) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Branch.class.getName()});
                return null;
            }
        }
